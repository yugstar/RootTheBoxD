...
class AdminUserUploadsHandler(BaseHandler):
    @restrict_ip_address
    @authenticated
    @authorized(ADMIN_PERMISSION)
    def get(self, *args, **kwargs):
        self.render("admin/view/uploads.html", errors=None)
...
class AdminEditTeamsUploadHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            self.render("admin/view/uploads.html", errors=[str(error)])
...
class AdminAjaxUserUploadsHandler(BaseHandler):
    @restrict_ip_address
    @authenticated
    @authorized(ADMIN_PERMISSION)
    def post(self, *args, **kwargs):
