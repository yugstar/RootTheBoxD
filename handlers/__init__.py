...
from handlers.UserFileUploadHandlers import *
from handlers.UserInstructionsHandlers import *
from handlers.TasksHandler import *
# from handlers.AdminManageTaskHandler import *
...
urls = [
    ...
    # User file upload Handler - UserFileUploadHandlers.py
    (r"/user/uploads/delete", UserFileDeleteHandler),
    (r"/user/shares/download(.*)", UserFileDownloadHandler),
    (r"/user/uploads/files", UserFileUploadHandler),
    # instructions
    (r"/user/uploads/instructions", UserInstructionsHandlers),
    #instructions end
...
# for admin uploads handler
    (r"/admin/uploads", AdminUserUploadsHandler),
    (r"/admin/uploads/edit/teams/scores", AdminEditTeamsUploadHandler),
    (r"/user/shares/download(.*)", AdminFileDownloadHandler),
    (r"/admin/uploads/delete", AdminFileDeleteHandler),
    (r"/admin/ajax/(user|team)", AdminAjaxUserUploadsHandler),
# upto here 
      
# Admin Managetask
    # (r"/admin/view/managetask", AdminManageTaskHandler),
    (r"/admin/view/managetask/edit/teams/scores", AdminEditTeamsUploadHandler),
    (r"/user/shares/download(.*)", AdminFileDownloadHandler),
    (r"/admin/view/managetask/delete", AdminFileDeleteHandler),
    (r"/admin/view/ajax/(user|team)", AdminAjaxUserUploadsHandler),
# Admin task Managetask

    (r"/admin/users", AdminManageUsersHandler),
    (r"/admin/users/edit/(user|team|task)", AdminEditUsersHandler),
